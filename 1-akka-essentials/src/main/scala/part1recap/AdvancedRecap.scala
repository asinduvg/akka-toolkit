...
object AdvancedRecap extends App {
  ...
  // lifting
  val lifted = partialFunction.lift // turns partial functions into total functions
  // total function Int => Option[Int]
  lifted(2) // Some(65)
  lifted(5000) // None // if not lifted throws a match error
