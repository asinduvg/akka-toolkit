...
object ScalaRecap extends App {
  ...
  // ExecutionContext - manager of threads
  ...
  future onComplete {
    ...
    case Failure(ex) => println(s"I found $ex while searching for the meaning of life!")
  } // on SOME thread
  ...
  // ii - imported scope
  // iii - companion objects of the types involved in the call
  object Person {
    implicit val personOrdering: Ordering[Person] = Ordering
      .fromLessThan((a, b) => a.name.compareTo(b.name) < 0)
  }
