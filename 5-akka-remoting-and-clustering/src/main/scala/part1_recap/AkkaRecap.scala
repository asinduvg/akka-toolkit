...
object AkkaRecap extends App {
  ...
  class SimpleActor extends Actor with ActorLogging with Stash {
    ...
    def anotherHandler: Receive = {
      case message => println(s"I received another: $message")
    }
  ...
  // #1: you ca instantiate an actor through the actor system
  ...
  /*
    ...
    - many actors (in the millions) can share few dozen threads
  ...
  // logging
  // supervision - how parent actors react on child actors failures
